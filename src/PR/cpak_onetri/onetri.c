...
#include <assert.h>
#include <PR/ncode.h>
#include <PR/libnos.h>	/* Controller pak menu */
#include "onetri.h"
...
boot(void)
{
    ...
    /* notice that you can't call rmonPrintf() until you set up the
     * rmon thread and have an idle thread running in the background.
     */
