	...
	switch(room) {
		case 0:
			osPiStartDma(&dmaIOMessageBuf, OS_MESG_PRI_NORMAL, OS_READ,
				(u32) _cafeSegmentRomStart, seg,
				(u32) _cafeSegmentRomEnd - (u32) _cafeSegmentRomStart,
				&dmaMessageQ);
		...
		case 1:
			osPiStartDma(&dmaIOMessageBuf, OS_MESG_PRI_NORMAL, OS_READ,
				(u32) _roadSegmentRomStart, seg,
				(u32) _roadSegmentRomEnd - (u32) _roadSegmentRomStart,
				&dmaMessageQ);
			(void) osRecvMesg(&dmaMessageQ, NULL, OS_MESG_BLOCK);
			rd = Road;
			break;
		...
		case 2:
			osPiStartDma(&dmaIOMessageBuf, OS_MESG_PRI_NORMAL, OS_READ,
				(u32) _worldSegmentRomStart, seg,
				(u32) _worldSegmentRomEnd - (u32) _worldSegmentRomStart,
				&dmaMessageQ);
			(void) osRecvMesg(&dmaMessageQ, NULL, OS_MESG_BLOCK);
			rd = World;
			break;
