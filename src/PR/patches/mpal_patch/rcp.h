 ...
 * 				Caution!				   *
 *									   *
 *  This "rcp.h" file is special version for NTSC and MPAL.		   *
 *  In this file, we set MPAL value instead of PAL value.		   *
 *  So, you must not use this file for PAL.				   *
 *  You can use this file for NTSC and MPAL only.			   *
 *			1996.6.28   Modified by Nintendo, Co., Ltd. 1996.  *
 *									   *
 **************************************************************************/
 ...
 *
 *  $Header: /mdev2/PR/include/RCS/rcp.h,v 1.14 1996/03/14 21:41:58 sjs Exp $
 *
 */
...
/*
 * Possible video clocks (NTSC or MPAL)
 *
 * 	!!Caution!!   The following VI_PAL_CLOCK is really VI_MPAL_CLOCK.
 */
#define VI_NTSC_CLOCK		48681812        /* Hz = 48.681812 MHz */
#define VI_PAL_CLOCK		48628316        /* Hz = 48.628316 MHz */
 ...
 *
 * 	!!Caution!!   
 *      The following AI_PAL_MAX_FREQ is really AI_MPAL_MAX_FREQ.
 *	And the following AI_PAL_MIN_FREQ is really AI_MPAL_MIN_FREQ.
 *
 */
#define AI_NTSC_MAX_FREQ        368000          /* 368 KHz */
#define AI_NTSC_MIN_FREQ        3000            /*   3 KHz ~ 2971 Hz */

#define AI_PAL_MAX_FREQ         368000          /* 368 KHz */
#define AI_PAL_MIN_FREQ         3000            /*   3 KHz ~ 2968 Hz */
