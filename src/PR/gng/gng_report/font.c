...
font_show_string( Gfx **glistp, char *val_str )
{
    ...
    /*
     * Allow subsequent font_show_string calls to display below the current text.
     */
    bm = sp->bitmap;
    yCorrection = ( (double)(bm[0].actualHeight) ) * font_yscale;
    yCorrection *= ( (double)(realSpriteHeight + 1) );
    font_ypos += ( (int)yCorrection + 8);
