...
Acmd *alAudioFrame(Acmd *cmdList, s32 *cmdLen, s16 *outBuf, s32 outLen)
{
	...
	*cmdLen = 0;
    ...
    {    
        client->samplesLeft = drvr->paramSamples +
            _timeToSamples(drvr, (*client->handler)(client));
    }
...
{
    s32 tmp1;
    f32 tmp2 = (f32) micros * synth->outputRate / 1000000.0;
...
{
    f32 tmp = (f32) samples * 1000000.0 / synth->outputRate;
    return (ALMicroTime) tmp;
}
